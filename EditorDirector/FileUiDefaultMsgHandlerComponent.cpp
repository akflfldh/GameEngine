...
Quad::FileUiDefaultMsgHandlerComponent::FileUiDefaultMsgHandlerComponent(FileUiWindowContoller* controller)
...
LRESULT Quad::FileUiDefaultMsgHandlerComponent::HandleMessage(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, bool& ret)
{
    ret = false;
    switch (msg)
    {
