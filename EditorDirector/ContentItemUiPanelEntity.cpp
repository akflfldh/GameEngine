...
//{
//	entity->GetUiMeshComponent()->SetIndependentRotationFlag(true);
//	entity->GetUiMeshComponent()->SetIndependentScaleFlag(true);
//
//	entity->GetUiComponent()->SetSelectAvailableFlag(false);
//
...
//	GetUiMeshComponent()->SetTexture("Gray.png");
//
