...
//  //  AddEffect(&mDragAndDropRenderSystem, EffectManager::GetEffect("WindowLayout.effect"), ESystemType::eWindowLayoutSystem);
//  //  AddEffect(&mDragAndDropRenderSystem, EffectManager::GetEffect("TextBox.effect"), ESystemType::eMainSystem);
//  //  AddEffect(&mDragAndDropRenderSystem, EffectManager::GetEffect("TextCharacter.effect"), ESystemType::eMainSystem);
//  //  AddEffect(&mDragAndDropRenderSystem, EffectManager::GetEffect("DefaultCollider.effect"), ESystemType::eMainSystem);
//
//
//
...
//
//
//    //Map* map = EditorMapManager::CreateEngineSystemMap(system, "ChildWindowDockingMainMap" + std::to_string((int)system->GetSystemID()));
//   
//   
//
//    //system->Initialize(window->GetClientWidth(), window->GetClientHeight(), map);
