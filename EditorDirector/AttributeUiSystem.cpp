...
//	:System(ESystemType::eMainSystem,ESystemID::eAttributeMainSystem,"AttributeUiSystem"), mRootPanel(nullptr), mPositionPanel(nullptr), mScalePanel(nullptr), mRotationPanel(nullptr)
...
//}
//
//void Quad::AttributeUiSystem::Initialize(UINT clientWidth, UINT clientHeight,Map * staticMap , Quad::Map* runtimeMap)
//{
...
//}
//
//void Quad::AttributeUiSystem::Start()
//{
//	System::Start();
//
//
...
//
//
//			CameraHelper::CalculateRay({ (float)clientPos.x,(float)clientPos.y }, system->GetViewPortGlobal(),
//				*camera, true, ray);
//
//			event->SetRay(ray);
//
...
//
//
//	float viewWidth =	GetViewPortGlobal().Width;
//	float viewHeight =GetViewPortGlobal().Height;
//
//	mainCamera->GetTransform().SetPositionLocal({ (float)viewWidth / 2,-1.0f * (float)viewHeight / 2 , 0 });
//	mainCamera->SetViewWidthAndHeight(viewWidth, viewHeight);
//	
//}
//
//
...
//
//		AttrUiSystemSelectObjectComponent * selectComponent = frameEntity->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
//		// select object
...
//			MeshComponent* meshComponent = preEntity->GetComponent<MeshComponent>();
...
//
//			
//			Material* mat = &entity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial;
//
...
//			{
//			case 0: //material
//				texture = entity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial.GetDiffuseMap();
//				if (texture == nullptr)
//					texture = TextureManager::GetTexture("MaterialAsset.png");
//
//				break;
...
//			case 2: //normal
//
//				texture = entity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial.GetNormalMap();
//				break;
//			}
//
//			if (texture != nullptr)
...
//
//			AttrUiSystemSelectObjectComponent* selectComponent = frame->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
...
//
//		
//			if (!CollisionHelper::Intersect(frame->GetComponent<MeshComponent>()->GetCollider(), ray, t))
//			{
...
//						int subMeshIndex = selectComponent->GetSubMeshIndex();
//					
//						selectedEntity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial = *mat;
//						frame->SetColorItensity({ 1.0f,1.0f,1.0f });
//					}
//				}
//			}
...
//
//
//			const std::vector<ModelSubMesh> & subMeshVector = entity->GetComponent<MeshComponent>()->GetSubMesh();
//			///activate subMeshVector.size()
//
...
//
//
//	float propertyPanelWidth = 2000;
//	float propertyPanelHeight = 50;
//
//	//fresnelR0
...
//	TransformPropertyPanel* fresnelR0Panel = TransformPropertyPanel::Create(map, mapLayerIndex, propertyPanelWidth, propertyPanelHeight, "fresnelR0",3);
//	
//
...
//	fresnelR0Panel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
//	int subMeshIndex = 0;
...
//
//				AttrUiSystemSelectObjectComponent * selectObjectComponent =panel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
...
//
//				Entity* entity = (Entity*)selectedObject;
//				DirectX::XMFLOAT3 fresnelR0 = entity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial.GetFresnelR0();
...
//				break;
//			}
//			entity->GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial.SetFresnelRO(fresnelR0);
//		}
//	};
//
...
//	//shiness
//
//	TransformPropertyPanel* shinessPanel = CreatePropertyPanel("ShinessPanel", "Shiness", propertyPanelWidth, propertyPanelHeight, 1, "Gray.png");
...
//	shinessPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
...
//			//�� ��ƼƼ�� ���͸��� ����ߴ� ��Ƽ�ݹ��� �����Ѵ�.
//			Entity* entity = (Entity*)selectedObject;
//			entity->GetComponent<MeshComponent>()->GetSubMesh()[subMeshIndex].mModelMaterial.RemoveDirtyCallback(callbackHandle);
//			callbackHandle = 0;
//		}
//		selectedObject = event->GetSelectObject();
...
//		{
//			Entity* entity = (Entity*)object;
//			entity->GetComponent<MeshComponent>()->GetSubMesh()[subMehsIndex].mModelMaterial.SetShiness(shiness);
//		}
//	});
//
//
...
//	//specular
//
//	TransformPropertyPanel* specularPanel = CreatePropertyPanel("SpecularPanel", "Specular", propertyPanelWidth, propertyPanelHeight, 3, "Gray.png");
...
//
////	selectObjectComponent = new AttrUiSystemSelectObjectComponent;
//	specularPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
...
//		AttrUiSystemSelectObjectComponent* selectComponent = panel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
//		GameObjectSelectEvent* event = (GameObjectSelectEvent*)pEvent;
//
...
//
//
//	TransformPropertyPanel* emissivePanel = CreatePropertyPanel("EmissivePanel", "Emissive", propertyPanelWidth, propertyPanelHeight, 3, "Gray.png");
//	subPanel2->AddChildPanelUiEntity(emissivePanel);
//	pos = specularPanel->GetTransform().GetPositionLocal();
//	pos.x = -subPanel2->GetWidth() / 2 + emissivePanel->GetWidth() / 2;
//	pos.y -= (emissivePanel->GetHeight() / 2 + emissivePanel->GetHeight() / 2);
//	pos.z = -1;
//
//	emissivePanel->GetTransform().SetPositionLocal(pos);
//
//	//selectObjectComponent = new AttrUiSystemSelectObjectComponent;
//	emissivePanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
//	emissivePanel->RegisterEventCallback("GameObjectSelect", [panel = emissivePanel, callbackHandle = 0](Event* pEvent) mutable {
//
//
//		AttrUiSystemSelectObjectComponent* selectComponent = panel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
...
//			callbackHandle = mat->AddDirtyCallback([panel, mat]() {
//
//				DirectX::XMFLOAT3 xyz = mat->GetEmissive();
//				panel->SetXYZ(xyz);
//				});
//
//			DirectX::XMFLOAT3 xyz = mat->GetEmissive();
...
//
//
//	auto emissiveTextEnterLamda = [panel = emissivePanel](int xyzIndex) {
//
//		/*AttrUiSystemSelectObjectComponent* selectComponent = (AttrUiSystemSelectObjectComponent*)panel->GetComponent(ComponentIDGenerator::GetID<AttrUiSystemSelectObjectComponent>());*/
//		AttrUiSystemSelectObjectComponent* selectComponent = panel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
...
//		};
//
//	emissivePanel->SetXTextBoxEnterCallback(std::bind(emissiveTextEnterLamda, 0));
//	emissivePanel->SetYTextBoxEnterCallback(std::bind(emissiveTextEnterLamda, 1));
//	emissivePanel->SetZTextBoxEnterCallback(std::bind(emissiveTextEnterLamda, 2));
//
//
//
//
...
//	assetImageFrameEntity->AddComponent<AttrUiSystemSelectObjectComponent>();
//
...
//
//	//AttrUiSystemSelectObjectComponent* selectComponent = new AttrUiSystemSelectObjectComponent;
//	skeletonImagePanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
...
//
//		float t = FLT_MAX;
//		if (!CollisionHelper::Intersect(panel->GetComponent<MeshComponent>()->GetCollider(), ray, t))
//		{
...
//	stateClipScrollListPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
...
//	//selectComponent = new AttrUiSystemSelectObjectComponent;
//	animationEdit3DPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
...
//			
//		float minT = FLT_MAX;
//		if (!CollisionHelper::Intersect(panel->GetComponent<MeshComponent>()->GetCollider(), ray, minT))
//		{
//			//panel->SetColorItensity({ 1.0f,1.0f,1.0f });
//			return;
//		}
...
//				entity->GetComponent<MeshComponent>()->SetMesh(animationClip->GetDefaultMesh());
//				AnimationComponent& animationComponent = *entity->GetComponent<AnimationComponent>();
...
////	selectComponent = new AttrUiSystemSelectObjectComponent;
//	splitTextBoxPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
//
//
...
////	selectComponent = new AttrUiSystemSelectObjectComponent;
//	stateCreationButtonPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//	//remove button panel
...
//	//selectComponent = new AttrUiSystemSelectObjectComponent;
//	stateRemoveButtonPanel->AddComponent<AttrUiSystemSelectObjectComponent>();
//
//
//
//
...
//		AttrUiSystemSelectObjectComponent* selectComponent = creationButtonPanel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
//		GameObjectSelectEvent* selectEvent = (GameObjectSelectEvent*)pEvent;
//		Object* selectedObject = selectEvent->GetSelectObject();
...
//
//			
//			if (entity->GetComponent<MeshComponent>()->GetMesh() != animationClip->GetDefaultMesh())
//			{
//				//에니메이션에맞는 메시가아니다.
...
//		AttrUiSystemSelectObjectComponent* selectComponent = removeButtonPanel->GetComponent< AttrUiSystemSelectObjectComponent>();
//
//
//		GameObjectSelectEvent* selectEvent = (GameObjectSelectEvent*)pEvent;
//		Object* selectedObject = selectEvent->GetSelectObject();
...
//
//	//selectComponent = new AttrUiSystemSelectObjectComponent;
//	editAnimationTranslationButton->AddComponent<AttrUiSystemSelectObjectComponent>();
//
...
//		AttrUiSystemSelectObjectComponent* selectComponent =button->GetComponent<AttrUiSystemSelectObjectComponent>();
//		GameObjectSelectEvent* selectEvent = (GameObjectSelectEvent*)pEvent;
//
//		Object * selectObject =	selectEvent->GetSelectObject();
//		AnimationComponent* animComponent = selectObject->GetComponent<AnimationComponent>();
//
//
//		AnimationStateTransitionGraphBasePanel* animationStateTransitionGraphBasePanel = AnimationStateTransitionGraphBasePanel::GetInstance();
//
