...
//}
//
//void Quad::BoundaryStick::HandleSelectEvent(const MouseInputData& mouseInputData)
//{
//	//MouseClickSelectEvent* selectEvent = (MouseClickSelectEvent*)event;
//	
//	//UiEntity::OnEvent(mouseInputData);
//
//
//}
//
//void Quad::BoundaryStick::HandleReleaseSelectEvent(const MouseInputData& mouseInputData)
//{
//
////	UiEntity::OnEvent(mouseInputData);
//
//}
//
//void Quad::BoundaryStick::HandleMouseMoveEvent(const MouseInputData& mouseInputData)
//{
...
//
//	GetUiMeshComponent()->SetTexture("BoundaryStick.bmp");
//
//
