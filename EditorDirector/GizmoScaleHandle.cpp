...
//{
//	Entity::Initialize();
//	GetComponent<MeshComponent>()->SetMesh(nullptr);
//
//
//
...
//	mBox->GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial.SetColor(color);
//	
//}
//
...
//		D3D12_VIEWPORT viewPort = system->GetViewPortGlobal();
//
//
//
//
...
//
////	mBox->Initialize();
//	MeshComponent* boxMeshComponent = mBox->GetComponent<MeshComponent>();
//	boxMeshComponent->SetMesh(MeshManager::GetMesh("Cube"));
//	boxMeshComponent->GetSubMesh()[0].mModelMaterial.SetEffectName("Gizmo.effect");
//	mBox->GetTransform().SetPositionWorld({ 0,5,0 });
//	mBox->SetEngineObjectFlag(true);
//
//	std::pair<DirectX::XMFLOAT3, DirectX::XMFLOAT3> minMaxPoint = boxMeshComponent->GetMesh()->GetMinMaxPoint();
//	minMaxPoint.second.y += 5;
//
//	BoxCollider *gizmoHandleBoxCollider =static_cast<BoxCollider*>(GetComponent<MeshComponent>()->GetCollider());
//	gizmoHandleBoxCollider->SetMinMaxVertex(minMaxPoint.first, minMaxPoint.second);
//	//SetCollider(ColliderGenerator::CreateBoxCollider(minMaxPoint.first, minMaxPoint.second));
//	//AddColliderComponent(ColliderGenerator::CreateBoxCollider(minMaxPoint.first, minMaxPoint.second));
//
//
//
