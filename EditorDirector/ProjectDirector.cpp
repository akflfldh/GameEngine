...
//	for (auto& projectMetaData : mProjectMetaDataVector)
//	{
//		JsonParser::StartWriteObject("ProjectMetaData"+std::to_string(projectIndex));
...
//
//		JsonParser::DescendIntoObjectOrArray("ProjectMetaData"+std::to_string(i));
...
//	GamePlaySystem* gamePlaySystem = GamePlaySystem::GetInstance();
//
//	EditorMap* map =static_cast<EditorMap*>(EditorMapManager::CreateMap(gamePlaySystem, mapName, false, true));
