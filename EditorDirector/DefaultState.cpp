...
//		if (cameraUi)
//		{
//			CameraHelper::CalculateRay(clientPos, system.GetViewPortGlobal(), *cameraUi, true, rayUi);
//			mouseEventUi.SetRay(rayUi);
//		}
//
//		if (camera3D)
//		{
//			CameraHelper::CalculateRay(clientPos, system.GetViewPortGlobal(), *camera3D, true, ray3D);
//			mouseEvent3D.SetRay(ray3D);
//		}
//
