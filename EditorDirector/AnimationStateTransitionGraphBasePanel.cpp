...
//
//	//JsonParser::StartWriteObject("AnimationStateTransitionGraphBasePanel");
//
...
//	//	JsonParser::StartWriteObject("AnimationTransitionGraph"+std::to_string(i));
//
...
//
//
//	//JsonParser::DescendIntoObjectOrArray("AnimationStateTransitionGraphBasePanel");
//
//
...
//	//{
//	//	JsonParser::DescendIntoObjectOrArray("AnimationTransitionGraph" + std::to_string(i));
//
...
//}
//
//void Quad::AnimationStateTransitionGraphBasePanel::HandleRButtonDown(const MouseInputData& inputData)
//{
//
...
//}
//
//void Quad::AnimationStateTransitionGraphBasePanel::HandleRButtonUp(const MouseInputData& inputData)
//{
////
////	StateComponent* stateComponent = GetStateComponent();
