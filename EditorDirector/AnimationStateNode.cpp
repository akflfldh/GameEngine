...
//{
//	//float t = FLT_MAX;
//	//MeshComponent * meshComponent =	mLinkEndNode->GetComponent<MeshComponent>();
//
//	//return 	CollisionHelper::Intersect(meshComponent->GetCollider(), ray, t);
//
//}
//
...
//}
//
//void Quad::AnimationStateNode::HandleLButtonDown(const MouseInputData& mouseInputData)
//{
//	AnimationStateTransitionBaseNode::HandleLButtonDown(mouseInputData);
//
//
//
//
...
//}
//
//void Quad::AnimationStateNode::HandleLButtonUp(const MouseInputData& mouseInputData)
//{
//	AnimationStateTransitionBaseNode::HandleLButtonUp(mouseInputData);
//
//
//
//}
...
//
//
//void Quad::AnimationStateNode::HandleMouseMove(const MouseInputData& mouseInputData)
//{
//	AnimationStateTransitionBaseNode::HandleMouseMove(mouseInputData);
...
//}
//
//void Quad::AnimationStateNode::HandleHover(const MouseInputData& mouseInputData)
//{
//
//	AnimationStateTransitionBaseNode::HandleHover(mouseInputData);
//
//
//
//
