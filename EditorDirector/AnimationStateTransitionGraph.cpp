...
//	
//	JsonParser::StartWriteObject("AnimationStateTransitionGraph");
//
...
//
//	for (size_t i = 0; i < mAnimationStateTransitionNodeVector.size(); ++i)
//	{
//		AnimationStateTransitionBaseNode * node =	mAnimationStateTransitionNodeVector[i];
//
//		JsonParser::StartWriteObject("AnimationStateTransitionNode"+std::to_string(i));
//
//		JsonParser::Write("NodeType", (int)node->GetAnimationNodeType());
//		JsonParser::Write("NodeID", (int)node->GetNodeID());
//
//		node->Serialize();
//
...
//
//	//JsonParser::AscendOutofObjectOrArray();
//	JsonParser::DescendIntoObjectOrArray("AnimationStateTransitionGraph");
//
//	size_t nodeNum = 0;
//	int nodeType = 0;
...
//	{
//		
//		JsonParser::DescendIntoObjectOrArray("AnimationStateTransitionNode" + std::to_string(i));
//
//
