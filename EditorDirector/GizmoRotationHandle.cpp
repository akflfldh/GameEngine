...
//{
//	//GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial.SetColor(color);
//
//}
//
...
//}
//
//void Quad::GizmoRotationHandle::HandleLButtonDown(const MouseInputData& mouseInputData)
//{
...
//}
//
//void Quad::GizmoRotationHandle::HandleLButtonUp(const MouseInputData& mouseInputData)
//{
//
//	//StateComponent* stateComponent = GetStateComponent();
//
...
//}
//
//void Quad::GizmoRotationHandle::HandleHover(const MouseInputData& mouseInputData)
//{
//	//StateComponent* stateComponent = GetStateComponent();
//
//	//MouseEvent* mouseEvent = (MouseEvent*)pEvent;
...
//}
//
//void Quad::GizmoRotationHandle::HandleMouseMove(const MouseInputData& mouseInputData)
//{
//
//
//
...
//	//	GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial.SetTextureTransformMatrix(0, texTransformMatrix);
//	//}
//	//else if (num == 3)
//	//{
//	//	DirectX::XMMATRIX rotationTransform;
...
//	mAxisType = axisType;
//
//	//GetComponent<MeshComponent>()->SetMesh(MeshManager::GetMesh("GizmoRotationCircle"));
//	//switch (axisType)
//	//{
//	//case EAxisType::eX:
...
//	//SetColor(mDefaultColor);
//
//	//GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial.SetEffectName("GizmoRotation.effect");
//
//	////원점위치
//	//GetTransform().SetPositionWorld({ 0,0,0 });
//	//mActiveQuadrantIndex = 1;
