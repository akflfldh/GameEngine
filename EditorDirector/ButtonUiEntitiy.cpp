...
//	}
//
//	void ButtonUiEntity::HandleHover(const MouseInputData& mouseInputData)
//	{
//
...
//	}
//
//	void ButtonUiEntity::HandleLButtonDown(const MouseInputData& mouseInputData)
//	{
//		/*StateComponent* stateComponent = GetStateComponent();
//
//		MouseEvent* mouseEvent = (MouseEvent*)pEvent;
...
//	}
//
//	void ButtonUiEntity::HandleLButtonUp(const MouseInputData& mouseInputData)
//	{
//		StateComponent* stateComponent = GetStateComponent();
//
//		if (stateComponent->GetLButtonDownState())
...
//
//
//	void ButtonUiEntity::HandleMouseMove(const MouseInputData& mouseInputData)
//	{
//
//
//
