...
//	
//	ScissorRectComponent * scissorRectComponent = AddComponent<ScissorRectComponent>();
//	scissorRectComponent->SetParentRectOverlapFlag(false);	//이textboxpanel이 자신의 sicssor영역을 가질것이다.
//	
