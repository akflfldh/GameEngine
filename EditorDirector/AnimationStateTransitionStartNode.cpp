...
//
//	mRootSceneComponent->SetIndependentRotationFlag(true);
//	mRootSceneComponent->SetIndependentScaleFlag(true);
//	GetUiMeshComponent()->SetTexture("Green.png");
//	GetUiMeshComponent()->SetWidthHeightLocal(20, 20);
//
...
//}
//
//void Quad::AnimationStateTransitionStartNode::HandleLButtonDown(const MouseInputData& mouseInputData)
//{
...
//}
//
//void Quad::AnimationStateTransitionStartNode::HandleLButtonUp(const MouseInputData& mouseInputData)
//{
//	//if (mSendLbuttonUpEventFlag == true)
//	//	return;
//
//	//PanelUiEntity::HandleLButtonUp(mouseInputData);
//	//
//	//
//	//
...
//}
//
//void Quad::AnimationStateTransitionStartNode::HandleMouseMove(const MouseInputData& mouseInputData)
//{
...
//
//	//		float t = 0.0f;
//	//		bool ret = CollisionHelper::Intersect(meshComponent->GetCollider(), ray, t);
//	//		if (ret && minT > t)
//	//		{
//	//			minT = t;
//	//			mTargetNode = node;
...
//}
//
//void Quad::AnimationStateTransitionStartNode::HandleHover(const MouseInputData& mouseInputData)
//{
//	PanelUiEntity::HandleHover(mouseInputData);
//
//}
