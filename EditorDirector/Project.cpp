...
//
//	for(int i=0; i<mSystemMapMetaDataVector.size(); ++i)
//	{ 
//	
//		JsonParser::StartWriteObject("MapMetaData"+std::to_string(i));
//		mSystemMapMetaDataVector[i]->Serialize();
//
...
//		JsonParser::DescendIntoObjectOrArray("MapMetaData" + std::to_string(i));
//
...
//	EditorMap* gamePlayEditorModeMap = static_cast<EditorMap*>(EditorMapManager::CreateMap(gamePlaySystem, defaultMapName,false,true));
//	
//
