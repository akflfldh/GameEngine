...
//	//	AnimationComponent* animComponent = destObject->GetComponent<AnimationComponent>();
//
//
//
...
//	//AnimationComponent * animationComponent = destObject->GetComponent<AnimationComponent>();
//
...
//	
//	auto uiMeshCom = GetUiMeshComponent();
//
//	float blendNodeWidth = uiMeshCom->GetWidthLocal();;
//	float blendNodeHeight = uiMeshCom->GetHeightLocal();
//
//
//	Transform & blendNodeTransform =	GetTransform();
//	uiMeshCom->SetIndependentRotationFlag(true);
//	uiMeshCom->SetIndependentScaleFlag(true);
//	uiMeshCom->SetTexture("Green.png");
//
//	GetUiComponent()->SetSelectAvailableFlag(false);
//
