...
//	}
//
//	void FileUiUiSystem::Initialize(UINT clientWidth, UINT clientHeight, Quad::Map* staticMap, Quad::Map* runtimeMap)
//	{
...
//		UINT clientWidth  =	GetClientWidth();
...
//
//		D3D12_VIEWPORT viewportGlobal = GetViewPortGlobal();
//		float viewWidth = viewportGlobal.Width;
//		float viewHeight = viewportGlobal.Height;
//
//		mainCamera->SetPosition((float)viewWidth / 2.0f, -1.0f * viewHeight / 2.0f, 0.0f);
