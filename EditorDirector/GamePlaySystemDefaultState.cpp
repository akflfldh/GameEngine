...
//    if (cameraUi)
//    {
//        CameraHelper::CalculateRay(screenPos, system.GetViewPortGlobal(), *cameraUi, true, rayUi);
//        mouseEventUi.SetRay(rayUi);
//    }
//
//    if (camera3D)
//    {
//        CameraHelper::CalculateRay(screenPos, system.GetViewPortGlobal(), *camera3D, true, ray3D);
...
//         if(meshComponent)
//             meshComponent->GetSubMesh()[0].mModelMaterial.SetDiffuseMap(texture);
//
//    }
//    break;
...
//                mEntity->GetComponent<MeshComponent>()->SetMesh(mesh);
...
//
//      entity->GetComponent<MeshComponent>()->GetSubMesh()[0].mModelMaterial = *material;
//       
//    }
//    break;
//
