...
//}
//
//void Quad::ClassListItemPanelEntity::HandleHover(const MouseInputData& mouseInputData)
//{
//
...
//}
//
//void Quad::ClassListItemPanelEntity::HandleLButtonDown(const MouseInputData& mouseInputData)
//{
//	/*StateComponent* stateComponent = GetStateComponent();
//
//	MouseEvent* mouseEvent = static_cast<MouseEvent*> (event);
