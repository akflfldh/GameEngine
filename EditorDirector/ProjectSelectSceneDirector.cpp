...
//	ScissorRectComponent * nameTextBoxScissorRectComponent =ProjectNameTextBox->GetComponent<ScissorRectComponent>();
//	nameTextBoxScissorRectComponent->SetParentRectOverlapFlag(false);
//
//
...
//	ScissorRectComponent* pathTextBoxScissorRectComponent = projectPathSearchTextBox->GetComponent<ScissorRectComponent>();
//	pathTextBoxScissorRectComponent->SetParentRectOverlapFlag(false);
//
//
//
//	//search path button
