...
bool D3DRender::D3DShaderReflectSystem::Reflect(void* compiledShader, size_t size, std::vector<ShaderResourceReflectInfo>& oReflectShaderResourceVector)
{
    ...
    ID3D12ShaderReflection* shaderReflection;
     ...
     for (size_t i = 0; i < boundedResourceNum; ++i)
     {
        ...
        shaderResourceReflectionInfo.mResourceDimension= ConvertToRenderShaderResourceDimension(inputResourceBindDesc.Dimension);
        shaderResourceReflectionInfo.mResourceType = ConvertToRenderShaderResourceType(inputResourceBindDesc.Type);

        shaderResourceReflectionInfo.mRegisterIndex = inputResourceBindDesc.BindPoint+inputResourceBindDesc.BindCount-1;
    ...
    //shaderReflection->GetResourceBindingDesc()
     ...
     //shaderReflection->GetVariableByName()    //실제 엔진에서 정해놓은대로 올바르게 변수들을 정의했는지도 검증할수있을것
...
Render::EShaderResourceDimension D3DRender::D3DShaderReflectSystem::ConvertToRenderShaderResourceDimension(D3D_SRV_DIMENSION shaderDimension)
{
    ...
    case D3D_SRV_DIMENSION_UNKNOWN:
        return Render::EShaderResourceDimension::eNone;
...
Render::EShaderResourceType D3DRender::D3DShaderReflectSystem::ConvertToRenderShaderResourceType(D3D_SHADER_INPUT_TYPE shaderInputType)
{
