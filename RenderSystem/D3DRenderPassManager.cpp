...
D3DRender::D3DRenderPassManager::D3DRenderPassManager(Microsoft::WRL::ComPtr<ID3D12Device> device,
    ...
    std::shared_ptr<D3DRender::D3DWindowRenderData> windowRenderData)
{
    ...
    std::unique_ptr<D3DOpaqueRenderPass> opaqueRenderPass = std::make_unique<D3DOpaqueRenderPass>(
        mDevice, mGpuResourceManager, mMaterialManager, backBuffer, depthStencilBuffer);
