...
struct MeshItem
{
    ...
    {
        if (mVertexBuffer != rhs.mVertexBuffer)
            return false;
        if (mIndexBuffer != rhs.mIndexBuffer)
            return false;
        if (mVertexNum != rhs.mVertexNum)
            return false;
        if (mVertexOffset != rhs.mVertexOffset)
            return false;
...
struct InternalRenderItem : public Render::RenderItem
{
    ...
    {
        if (mFirstSortKey != rhs.mFirstSortKey)
            return mFirstSortKey < rhs.mFirstSortKey;

        if (mSecondSortKey != rhs.mSecondSortKey)
            return mSecondSortKey < rhs.mSecondSortKey;
