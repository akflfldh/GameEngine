...
namespace Render
{
	...
	public:
		...
		virtual void SubmitRenderItems(Render::RenderChannelID channelID, const std::vector<Render::RenderItem>& renderItemVector) = 0;
		//virtual void SubmitRenderItems(Render::RenderChannelID channelID, std::vector<Render::RenderItem>&& renderItemVector) = 0;
