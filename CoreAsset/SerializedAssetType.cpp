...
// }
//
// void CoreAsset::SerializedMaterial::Serialize(QuadRW::BinaryWriter &writer)
//{
//     SerializedAsset::Serialize(writer);
...
// }
//
// void CoreAsset::SerializedMaterial::DeSerialize(QuadRW::BinaryReader &reader)
//{
//     SerializedAsset::DeSerialize(reader);
...
// }
//
// CoreAsset::SerializedAssetFactory *CoreAsset::SerializedAssetFactory::GetInstance()
//{
//     static SerializedAssetFactory instance;
//     return &instance;
// }
//
// CoreAsset::SerializedAssetFactory::SerializedAssetFactory() {}
//
// CoreAsset::SerializedAssetFactory::~SerializedAssetFactory() {}
//
// template <typename T> T *CoreAsset::SerializedAssetFactory::SerializedAssetFactory::CreateSerializedAssetStructure()
//{
//
//     // 커스텀 할당자사용으로 향후 리펙토링
//     return new T;
// }
//
// template <typename T> void CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure(T *structure)
//{
//     delete structure;
// }
//
// template CoreAsset::SerializedAsset *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedAsset>();
//
// template CoreAsset::SerializedTexture *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedTexture>();
//
// template CoreAsset::SerializedAssetRawData *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedAssetRawData>();
//
// template CoreAsset::SerializedTextureRawData *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedTextureRawData>();
//
// template CoreAsset::SerializedTextureRuntime *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedTextureRuntime>();
//
// template CoreAsset::SerializedMaterial *CoreAsset::SerializedAssetFactory::CreateSerializedAssetStructure<
//     CoreAsset::SerializedMaterial>();
//
//
//
//// ReleaseSerializedAssetStructure<T>(T*) 명시적 인스턴스화
// template void CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedAsset>(
//     CoreAsset::SerializedAsset *);
//
// template void CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedTexture>(
//     CoreAsset::SerializedTexture *);
//
// template void CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedAssetRawData>(
//     CoreAsset::SerializedAssetRawData *);
//
// template void
// CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedTextureRawData>(
//     CoreAsset::SerializedTextureRawData *);
//
// template void
// CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedTextureRuntime>(
//     CoreAsset::SerializedTextureRuntime *);
//
// template void CoreAsset::SerializedAssetFactory::ReleaseSerializedAssetStructure<CoreAsset::SerializedMaterial>(
//     CoreAsset::SerializedMaterial *);