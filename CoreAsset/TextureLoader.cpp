...
std::unique_ptr<CoreAsset::SerializedTexture> CoreAsset::TextureLoader::LoadAssetFile(const std::string& filePath, CoreAsset::AssetMetaData & oMetaData)
{
...
std::unique_ptr<CoreAsset::SerializedTextureRawData> CoreAsset::TextureLoader::LoadRawFile(const std::string& filePath)
{
	...
	std::unique_ptr<CoreAsset::SerializedTextureRawData> serializedTextureRawData = std::make_unique<SerializedTextureRawData>();
