...
GRM::GpuSamplerSystem *GRM::GpuSamplerSystem::mInstance = nullptr;

GRM::GpuSamplerSystem *GRM::GpuSamplerSystem::GetInstance()
{
...
GRM::GpuSamplerSystem::GpuSamplerSystem(GRM::IGpuResourceManager *gpuResourceManager)
...
GRM::GpuSamplerSystem::~GpuSamplerSystem() {}

void GRM::GpuSamplerSystem::LoadShaderSamplerFile(const std::string &filePath)
{
...
GRM::GRMPtr GRM::GpuSamplerSystem::GetGpuSampler(uint32_t id) const
{
...
bool GRM::GpuSamplerSystem::CreateSampler(uint32_t samplerID)
{

    return false;
}

GRM::ESamplerAddressMode GRM::GpuSamplerSystem::ConvertToSamplerAddressMode(const char *addressMode) const
{
...
GRM::ESamplerFilterMode GRM::GpuSamplerSystem::ConvertToSamplerFilterMode(const char *filterMode) const
{
