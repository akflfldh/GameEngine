...
{
  public:
    D3DGpuDescriptorHeapManager(Microsoft::WRL::ComPtr<ID3D12Device> device, D3D12_DESCRIPTOR_HEAP_TYPE type,
  ...
  private:
    ...
    std::vector<size_t> mFreeDecriptorOffsetVector; // 마지막에있는 offset을 꺼내쓰고, 반환된 오프셋은 다시 마지막에
                                                    // 푸시
};
