...
class GPURESOURCE_MANAGER_API D3DGpuResourceManager : public GRM::IGpuResourceManager
{
  ...
  public:
    ...
    virtual GRM::GRMPtr CreateSampler(const GRM::SamplerDesc &samplerDesc) override;
  ...
  private:
    ...
    bool UploadBufferData(Microsoft::WRL::ComPtr<ID3D12Resource> uploadBuffer, void *data, size_t elementSize,
                          size_t elementNum, size_t bufferOffset = 0);
