...
void D3DGRM::D3DGpuResource::SetDescriptorHandle(D3DGRM::ED3DResourceDescriptorType type, const D3DDescriptorHandle descriptorHandle)
{
	mDescriptorHandleTable[type] = descriptorHandle;
}

bool D3DGRM::D3DGpuResource::GetDescriptorHandle(D3DGRM::ED3DResourceDescriptorType type, D3DDescriptorHandle& descriptorHandle)
{
