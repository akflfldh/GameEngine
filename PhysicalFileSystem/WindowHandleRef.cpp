...
QuadPF::WindowHandleRef::WindowHandleRef(HANDLE handle) : mControlBlock(nullptr)
{
...
QuadPF::WindowHandleRef::WindowHandleRef(const QuadPF::WindowHandleRef &rhs) : mControlBlock(rhs.mControlBlock) {}
...
QuadPF::WindowHandleRef::WindowHandleRef(QuadPF::WindowHandleRef &&rhs) : mControlBlock(std::move(rhs.mControlBlock)) {}
