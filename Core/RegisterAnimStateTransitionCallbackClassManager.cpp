...
//	//auto instance = GetInstance();
//
//	//JsonParser::StartWriteObject("RegisterAnimStateTransitionCallbackClassManager");
...
//
//	
//	for (size_t i = 0; i < mRegisterAnimStateTransitionCallbackClassVector.size(); ++i)
//	{
//		JsonParser::StartWriteObject("RegisterAnimStateTransitionCallbackClass"+std::to_string(i));
//		mRegisterAnimStateTransitionCallbackClassVector[i]->Serialize();
...
//
//
//	//JsonParser::DescendIntoObjectOrArray("RegisterAnimStateTransitionCallbackClassManager");
...
//	{
//		JsonParser::DescendIntoObjectOrArray("RegisterAnimStateTransitionCallbackClass" + std::to_string(i));
//
