...
//	:mDestObject(nullptr),mDeltaX(0), mDeltaY(0), mRotationScreenX(0), mRotationScreenY(0)
//{
...
//
//	DirectX::XMFLOAT4 currQuaternionWF = mDestObject->GetObjectQuaternionWorld();
...
//	mDestObject->SetObjectQuaternionWorld(currQuaternionWF);
//
//
//
