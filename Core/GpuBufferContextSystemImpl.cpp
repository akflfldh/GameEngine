...
void Core::GpuBufferContextSystemImpl::LoadShaderBufferFile(const std::string &filePath)
{
...
bool Core::GpuBufferContextSystemImpl::RegisterGpuBufferCallback(uint32_t id,
...
bool Core::GpuBufferContextSystemImpl::CreateGpuBuffer(uint32_t bufferID, GRM::EBufferUsage bufferUsage,
...
uint32_t Core::GpuBufferContextSystemImpl::CacluateConstantBufferSize(uint32_t size) const
{
