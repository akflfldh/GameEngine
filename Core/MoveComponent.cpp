...
//	:mDestObject(nullptr), mSpeed(1.0f),mForwardDir(0.0f), mSideDir(0.0f)
//{
...
//
//	DirectX::XMFLOAT3 lookWorld = mDestObject->GetObjectLookWorld();
//	DirectX::XMFLOAT3 posWorld = mDestObject->GetObjectPositionWorld();
//
...
//
//
//	mDestObject->SetObjectPositionWorld(posWorld);
//
//	mForwardDir = 0.0f;
//}
//
...
//		return;
//	Transform& transform = mDestObject->GetTransform();
//	DirectX::XMFLOAT3 rightWorld = mDestObject->GetObjectRightWorld();
//	DirectX::XMFLOAT3 posWorld = mDestObject->GetObjectPositionWorld();
//	
