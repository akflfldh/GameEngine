...
#define CASTMATRIX4X4(pMatrix4X4) reinterpret_cast<DirectX::XMFLOAT4X4*>(pMatrix4X4)	//비상수 Vector4 캐스팅
    ...
    Vector2 Vector2::operator+(const Vector2& rhs) const
    {
        ...
        DirectX::XMStoreFloat2(&vf2, DirectX::XMVectorAdd(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), DirectX::XMLoadFloat2(CCASTVECTOR2(&rhs))));
    ...
    {
        DirectX::XMFLOAT2 vf2;
        DirectX::XMStoreFloat2(&vf2, DirectX::XMVectorSubtract(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), DirectX::XMLoadFloat2(CCASTVECTOR2(&rhs))));
        return Vector2(vf2.x, vf2.y);
    }
    ...
    {
        DirectX::XMStoreFloat2(CASTVECTOR2(this), DirectX::XMVectorAdd(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), DirectX::XMLoadFloat2(CCASTVECTOR2(&rhs))));
        return *this;
    }
    ...
    Vector2& Vector2::operator-=(const Vector2& rhs)
    {
        DirectX::XMStoreFloat2(CASTVECTOR2(this), DirectX::XMVectorSubtract(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), DirectX::XMLoadFloat2(CCASTVECTOR2(&rhs))));
        return *this;
    }
    ...
    {
        DirectX::XMStoreFloat2(CASTVECTOR2(this), DirectX::XMVectorScale(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), scalar));
        return *this;
    }
    ...
    {
        return DirectX::XMVectorGetX(DirectX::XMVector2Dot(DirectX::XMLoadFloat2(CCASTVECTOR2(this)), DirectX::XMLoadFloat2(CCASTVECTOR2(&vector))));
    }
    ...
    Vector3 Vector3::operator+(const Vector3& rhs) const
    {
        ...
        DirectX::XMStoreFloat3(&vf3, DirectX::XMVectorAdd(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&rhs))));
    ...
    {
        DirectX::XMFLOAT3 vf3;
        DirectX::XMStoreFloat3(&vf3, DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&rhs))));
        return Vector3(vf3.x, vf3.y, vf3.z);
    }
    ...
    {
        DirectX::XMStoreFloat3(CASTVECTOR3(this), DirectX::XMVectorAdd(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&rhs))));
        return *this;
    }
    ...
    Vector3& Vector3::operator-=(const Vector3& rhs)
    {
        DirectX::XMStoreFloat3(CASTVECTOR3(this), DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&rhs))));
        return *this;
    }
    ...
    {
        DirectX::XMStoreFloat3(CASTVECTOR3(this), DirectX::XMVectorScale(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), scalar));
        return *this;
    }
    ...
    {
        return DirectX::XMVectorGetX(DirectX::XMVector3Dot(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&vector))));
    }
    ...
    {
        DirectX::XMFLOAT3 vf3;
        DirectX::XMStoreFloat3(&vf3, DirectX::XMVector3Cross(DirectX::XMLoadFloat3(CCASTVECTOR3(this)), DirectX::XMLoadFloat3(CCASTVECTOR3(&rhs))));
        return Vector3(vf3.x, vf3.y, vf3.z);
    }
    ...
    Vector4 Vector4::operator+(const Vector4& rhs) const
    {
        ...
        DirectX::XMStoreFloat4(&vf4, DirectX::XMVectorAdd(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&rhs))));
    ...
    Vector4 Vector4::operator-(const Vector4& rhs) const
    {
        ...
        DirectX::XMStoreFloat4(&vf4, DirectX::XMVectorSubtract(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&rhs))));
    ...
    {
        DirectX::XMStoreFloat4(CASTVECTOR4(this), DirectX::XMVectorAdd(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&rhs))));
    ...
    Vector4& Vector4::operator-=(const Vector4& rhs)
    {
        DirectX::XMStoreFloat4(CASTVECTOR4(this), DirectX::XMVectorSubtract(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&rhs))));
    ...
    {
        DirectX::XMStoreFloat4(CASTVECTOR4(this), DirectX::XMVectorScale(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), scalar));
    ...
    {
        return DirectX::XMVectorGetX(DirectX::XMVector4Dot(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&vector))));
    ...
    Quaternion Quaternion::operator*(const Quaternion& rhs) const
    {
        ...
        DirectX::XMStoreFloat4(CASTVECTOR4(&quaternion),
            DirectX::XMQuaternionMultiply(DirectX::XMLoadFloat4(CCASTVECTOR4(this)), DirectX::XMLoadFloat4(CCASTVECTOR4(&rhs))));
    ...
    Matrix4X4 Matrix4X4::MakeTranslation(Vector3 position)
    {
        ...
        Matrix4X4 matrix;
        DirectX::XMStoreFloat4x4(CASTMATRIX4X4(&matrix), DirectX::XMMatrixTranslationFromVector(DirectX::XMLoadFloat3(CCASTVECTOR3(&position))));
    ...
    {
        Matrix4X4 matrix;
        DirectX::XMStoreFloat4x4(CASTMATRIX4X4(&matrix), DirectX::XMMatrixScalingFromVector(DirectX::XMLoadFloat3(CCASTVECTOR3(&scale))));
    ...
    Matrix4X4 Matrix4X4::MakeTransform(Vector3 position, Quaternion rotation, Vector3 scale)
    {
        ...
        DirectX::XMStoreFloat4x4(CASTMATRIX4X4(&matrix),
            DirectX::XMMatrixAffineTransformation(
                DirectX::XMLoadFloat3(CCASTVECTOR3(&scale)),
    ...
    void Matrix4X4::MatrixDecompose(Vector3& oPosition, Quaternion& oQuaternion, Vector3& oScale, const Matrix4X4& matrix)
    {
        ...
        DirectX::XMMatrixDecompose(&positionVector, &quaternion, &scalingVector, DirectX::XMLoadFloat4x4(CCASTMATRIX4X4(&matrix)));
